...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen bg-gray-100">
      ...
      <Image src={dashboard} height={100} width={30} alt={"dashboard"} />
